    ...
    <div class="popular container">
        ...
        <div class="popular__posts">
            ...
            <?php foreach ($articles as $article): ?>
                <article class="<? echo $article['type']; ?> popular__post post">
                    <header class="post__header">
                        <h2><?php echo $article['title']; ?></h2>
                    </header>
                    <div class="post__main">
                        <?php if ($article['type'] == 'post-quote') : ?>
                            <blockquote>
                                <p>
                        ...
                        <?php elseif ($article['type'] == 'post-link') : ?>
                            ...
                            <div class="post-link__wrapper">
                                <a class="post-link__external" href="<?php echo $article['content']; ?>"
                                   title="Перейти по ссылке">
                                    ...
                                    <span><?php echo $article['link']; ?></span>
                                </a>
                            </div>
                        <?php elseif ($article['type'] == 'post-photo') : ?>
                            <!--содержимое для поста-фото-->
                            <div class="post-photo__image-wrapper">
                                <img src="img/<?php echo $article['content']; ?>" alt="Фото от пользователя" width="360"
                                     height="240">
                            </div>
                        <?php elseif ($article['type'] == 'post-video') : ?>
                        ...
                        <div class="post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                <div class="post__avatar-wrapper">
                                    ...
                                    <img class="post__author-avatar" src="img/<?php echo $article['avatar']; ?>"
